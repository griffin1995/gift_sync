  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow': '0 0 20px rgba(240, 61, 255, 0.3)',
        'glow-lg': '0 0 40px rgba(240, 61, 255, 0.4)',
      },
      animation: {
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 20px rgba(240, 61, 255, 0.3)' },
          '100%': { boxShadow: '0 0 40px rgba(240, 61, 255, 0.6)' },
        },
      },
      backdropBlur: {
        xs: '2px',
